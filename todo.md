* A Shiny app that allows a user to draw datasets on a graph then have the data points generated automatically, can slider Variance, disturbance points etc.
